        ...
        <section itemprop="articleBody">
            ...
            ?>
                    <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <a itemprop="item" href="<?php echo get_site_url(null,'/about-us/testimonials') ?>"><span itemprop="name">Testimonials</span></a>
                        </li>
            ...
            <?php
                ...
                if ($uri_array[1] == 'programs' && strlen($uri_array[2]) > 0) {
            ?>
                    <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <a itemprop="item" href="<?php echo get_site_url(null,'/') ?>"><span itemprop="name">Home</span></a>
                        ...
                        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <a itemprop="item" href="<?php echo get_site_url(null,'/programs') ?>"><span itemprop="name">Programs</span></a>
                        </li>
                        <li class="active"><?php the_title(); ?></li>
                    </ol>
            <?php
