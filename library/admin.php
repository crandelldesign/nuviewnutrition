...
function template_login_css() {
	wp_enqueue_style( 'template_login_css', get_template_directory_uri() . '/assets/css/login.min.css', false );
}
...
function template_admin_css() {
    wp_enqueue_style( 'template_admin_css', get_template_directory_uri() . '/assets/css/admin.css', false );
}
...
function template_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="https://www.crandelldesign.com" target="_blank">Crandell Design</a></span>.', 'templatetheme' );
}
